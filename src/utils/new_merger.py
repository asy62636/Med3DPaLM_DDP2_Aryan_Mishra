...
class ModelArguments:
    ...
    peft_model_path: Optional[str] = field(
        default="./output2/Med3DVLM-Qwen-2.5-7B-ParGo-finetune-with-pos/checkpoint-174265"
    )
    ...
    use_positional_embedding: bool = field(default=True)  # Set to True!
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    output_dir: str = "./output2/Med3DVLM-Qwen-2.5-7B-ParGo-MERGED"
