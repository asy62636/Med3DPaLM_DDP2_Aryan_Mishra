...
# VQA Open-Ended Evaluation Script for Med3DVLM with Positional Embeddings
# ============================================================================
...
echo ""
echo "================================"
echo "Starting VQA Open-Ended Evaluation With Pos Embeddings..."
echo "================================"
echo ""
...
PYTHONPATH=. python src/eval/eval_vqa_test.py \
    ...
    --output_dir ./output/eval_vqa_open_test_with_pos/ \
    > ./test_logs/pargo_with_pos_embedding_open_ended_$(date +%Y%m%d_%H%M%S).log 2>&1
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "✓ Open-Ended Evaluation Complete!"
else
    echo "✗ Evaluation failed with exit code $EXIT_CODE"
fi
echo "Finished at: $(date)"
echo "Log location: ./test_logs/"
echo "Results location: ./output/eval_vqa_open_test_with_pos/"
echo "================================"
