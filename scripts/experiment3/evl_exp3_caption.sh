...
PYTHONPATH=. python src/eval/eval_caption_stage3.py \
    ...
    --output_dir /home/medal/ankit_k/Med3DVLM_and_Pargo/experiments/output/eval_exp3_stage3_caption \
    --data_root ./data \
    --cap_data_path ./data/M3D_Cap_npy/M3D_Cap.json \
    > /home/medal/ankit_k/Med3DVLM_and_Pargo/experiments/test_logs/eval_exp3_stage3_caption.txt 2>&1
